...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new zyz.flutter.plugin.flutter_google_street_view.FlutterGoogleStreetViewPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin flutter_google_street_view, zyz.flutter.plugin.flutter_google_street_view.FlutterGoogleStreetViewPlugin", e);
    }
    try {
    ...
    try {
      flutterEngine.getPlugins().add(new com.arslan.image_decode.ImageDecodePlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin image_decode, com.arslan.image_decode.ImageDecodePlugin", e);
    }
    try {
